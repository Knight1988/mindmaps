...
mindmaps.Command.prototype = {
     ...
     */
    setCss: function (css) {
        this.publish(mindmaps.Command.Event.CSS_CHANGED, css);
    },
...
/**
 * Creates a new LeftMenuCommand.
 * 
 * @constructor
 * @augments mindmaps.Command
 */
mindmaps.LeftMenuCommand = function () {
    this.id = "LEFTMENU_COMMAND";
    this.icon = "ui-icon-document";
    this.label = "Hide Menu";
