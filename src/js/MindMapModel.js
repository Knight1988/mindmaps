...
mindmaps.MindMapModel = function(eventBus, commandRegistry, undoController) {
    ...
    this.init = function() {
        ...
        eventBus.subscribe(mindmaps.Event.DOCUMENT_CLOSED,
            function() {
                createNodeCommand.setVisible(false);
                createSiblingNodeCommand.setVisible(false);
                deleteNodeCommand.setVisible(false);
            });

        eventBus.subscribe(mindmaps.Event.DOCUMENT_OPENED,
            function() {
                createNodeCommand.setVisible(false);
                createSiblingNodeCommand.setVisible(false);
                deleteNodeCommand.setVisible(false);
        ...
        eventBus.subscribe(mindmaps.Event.DOCUMENT_EDIT,
            function() {
                createNodeCommand.setVisible(true);
                createSiblingNodeCommand.setVisible(true);
                deleteNodeCommand.setVisible(true);
            });
    };
